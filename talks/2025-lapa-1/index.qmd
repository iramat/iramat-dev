...
# L'ouverture des données sur le web 
...
::: {.column width="50%"}
![](https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-github-4.png){width="75" style="horizontal-align: middle;"}
<small>
...
Un notebook Jupyter est accessible ici : [IRAMAT BDDs.ipynb](https://colab.research.google.com/drive/1EHUO9JaBNLIyNdiHLCTtPAODgFhEvgcq)
