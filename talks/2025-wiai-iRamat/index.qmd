...
1. <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/prog-r-1.png' style='height: 45px;vertical-align: middle;'>
...
# R <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/prog-r-1.png' style='height: 120px;vertical-align: middle;'>
...
::: {.column width="70%"}
R est un language de script orienté statistiques (essais cliniques, analyse de survie, etc.). C'est le plus utilisé par les archéologues[^1] qui utilisent les _packages_ génériques comme `ggplot` <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/r-pkg-ggplot.png' style='width: 40px;vertical-align: middle;'>pour les graphiques (développé par Hadley Wickham), `terra` <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/r-pkg-terra.png' style='width: 40px;vertical-align: middle;'> et `sf` <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/r-pkg-sf.png' style='width: 40px;vertical-align: middle;'> pour l'analyse spatiale, etc. 

et du code R est régulièrement publié en _supplementary material_ dans des articles Pour , _Chief Scientist_ pour Posit (ancien<sup>t</sup> RStudio)
