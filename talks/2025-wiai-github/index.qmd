...
Webinaire sur un thème lié aux technologies de l'information pour l'archéologie et l'archéométrie:  <br>
...
::: {.column width="65%"}
Git <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-git.png' style='height: 45px;vertical-align: middle;'> est un __logiciel de gestion de versions décentralisé__[^1] originallement créé par Linus Torvalds pour le contrôle de version dans le développement du noyau Linux.
...
<div class="captiontext">Linus Torvalds, _"Git is not designed to make you happy. It’s designed to make other people happy after you’ve screwed things up"_ (c) Lf Asia </div>
:::
...
<img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-git-workflow.png' style='height: 500px;vertical-align: middle;'>
