...
<small>Mettre la copie du dépôt distant[^4] à jour:</small>
...
<small>Mettre la copie du dépôt local[^5] à jour:</small>
...
::: {.column width="33%"}
Afficher des fichiers structurés: CSV, TSV, PDF, GeoJSON, HTML
:::

::: {.column width="33%"}
Visibilité du développement logiciel et des données de référence
:::
...
GitLab <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-gitlab.png' style='height: 40px;vertical-align: middle;'> : plateforme indépendante (🔓, GitLab Inc.) avec un hébergement cloud ou un auto-hébergement, pour les projets [open source] de développement d'applications informatiques utilisant <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-git-1.png' style='height: 40px;vertical-align: middle;'>.
