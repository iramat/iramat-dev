...
<div class="captiontext">Charles Babbage, _"I wish God these calculations had been done by stream"_ -- 1821 <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/lod-licences-publicdomain-1.png' style='height: 15px;vertical-align: middle;'> Wikipedia </div>
...
1. Git <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-git-1.png' style='height: 40px;vertical-align: middle;'>
2. GitHub <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-github.png' style='height: 40px;vertical-align: middle;'> 
3. GitHub à l'IRAMAT <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-github.png' style='height: 40px;vertical-align: middle;'> <img src='https://raw.githubusercontent.com/iramat/iramat-dev/master/img/logo.png' style='height: 40px;vertical-align: middle;'> 
4. Et GitLab <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-gitlab.png' style='height: 40px;vertical-align: middle;'> ?
5. Discussion
...
::: {.callout-note}
Un dépôt local[^4] ou distant[^5] : système de dossiers et fichiers[^6] conservant sont propre historique (fichier caché `.git`) et un lien vers le dépôt (local ou distant).
:::
...
- Gauche: arborescence du dépôt local `IRAMAT-DEV`
...
GitHub <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-github.png' style='height: 40px;vertical-align: middle;'> une des principales plate-forme web propriétaire (🔒, hébergement cloud Microsoft <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-os-microsoft-windows-10.png' style='height: 40px;vertical-align: middle;'>) pour les projets _open source_ de développement d'applications informatiques utilisant <img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/app-git-1.png' style='height: 40px;vertical-align: middle;'>
...
<img src='https://raw.githubusercontent.com/zoometh/thomashuet/master/img/web-address-io.jpg' style='width: 250px;vertical-align: middle;'>
<small>Avoir une belle (i.e., courte) adresse: <https://github.com/iramat> et échanger des URLs</small>
:::

::: {.column width="33%"}
<small>Afficher des fichiers structurés: CSV, TSV, PDF, GeoJSON, HTML</small>
:::

::: {.column width="33%"}
https://caa-france.github.io/website/diagrams/oarch_repo_user.html
